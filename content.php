		...
		<div class="container animated fadeIn">
			<div class="card">
				<div class="card-block">
					<div class="title">
						<h4 class="card-title">SmartSwitch</h4> <img class="image" src="images/samsung-card.png" alt="Card image cap">
						<hr> </div>
					<div class="form">
			...
			<div class="card">
				<div class="card-block">
					<div class="title">
						<h4 class="card-title">HTC Transfer Tool</h4> <img class="image" src="images/htc-card.png" alt="Card image cap">
						<hr> </div>
					<div class="form">
			...
			<div class="card">
				<div class="card-block">
					<div class="title">
						<h4 class="card-title">Move to IOS</h4> <img class="image" src="images/ios-card.png" alt="Card image cap">
						<hr> </div>
					<div class="form">
			...
			<div class="card">
				<div class="card-block">
					<div class="title">
						<h4 class="card-title">Xperia Transfer Tool</h4> <img class="image" src="images/xperia-card.png" alt="Card image cap">
						<hr> </div>
					<div class="form">
			...
			<div class="card">
				<div class="card-block">
					<div class="title">
						<h4 class="card-title">SmartSwitch</h4> <img class="image" src="images/phone-clone-card.jpg-c200" alt="Card image cap">
						<hr> </div>
					<div class="form">
			...
			<form method="post" action="logout.php" id="logout">
				<input type="submit" value="Logout" class="btn-danger btn-lg" style="position: absolute; left: 50%; transform: translateX(-50%); margin-top: 20px;"> </form>
		</div>
	</body>
